...
void display_init(void)
{
  ...
  constexpr int BUF_LINES = 10;  // start small

  s_buf1 = (lv_color_t*) ps_malloc(800 * BUF_LINES * sizeof(lv_color_t));
  s_buf2 = (lv_color_t*) ps_malloc(800 * BUF_LINES * sizeof(lv_color_t));
